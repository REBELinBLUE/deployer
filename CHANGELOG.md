...
- \#39 fixed, referenced the way from my another project's logging. [\#40](https://github.com/REBELinBLUE/deployer/pull/40) ([iflamed](https://github.com/iflamed))
...
- Route models [\#1](https://github.com/REBELinBLUE/deployer/pull/1) ([REBELinBLUE](https://github.com/REBELinBLUE))
