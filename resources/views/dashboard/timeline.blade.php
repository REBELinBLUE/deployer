    ...
    @foreach ($latest as $date => $deployments)
        ...
        <li>
            ...
            <div class="timeline-item">
                ...
                <h3 class="timeline-header"><a href="{{ url('projects', $deployment->project_id) }}">{{ $deployment->project->name }} </a> - <a href="{{ route('deployment', $deployment->id) }}">{{ Lang::get('dashboard.deployment_number', ['id' => $deployment->id]) }}</a> - {{ $deployment->readable_status }}</h3>
