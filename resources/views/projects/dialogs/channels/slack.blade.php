<div class="channel-config" id="channel-config-slack">
    <div class="form-group">
        <label for="notification_config_icon">{{ trans('channels.icon') }}</label>
        <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" title="{{ trans('channels.icon_info') }}"></i>
    ...
    <div class="form-group">
        <label for="notification_config_channel">{{ trans('channels.channel') }}</label>
        <div class="input-group">
    ...
    <div class="form-group">
        <label for="notification_config_webhook">{{ trans('channels.webhook') }}</label>
        <div class="input-group">
