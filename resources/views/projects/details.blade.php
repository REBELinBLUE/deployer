            ...
            <div class="box box-default">
                ...
                <div class="box-body no-padding">
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li><a href="#">{{ Lang::get('projects.latest_duration') }}<span class="pull-right">{{ (count($deployments) == 0 OR !$deployments[0]->finished_at) ? Lang::get('app.not_application') : human_readable_duration($deployments[0]->runtime()) }} </span></a></li>
                    </ul>
                </div>
            </div>
        </div>
