                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group pull-right">
                            <a href="{{ route($route, ['project' => $project->id, 'step' => 'clone']) }}" class="btn btn-default" title="{{ trans('commands.configure') }}"><i class="fa fa-gear"></i></a>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="btn-group pull-right">
                            <a href="{{ route($route, ['project' => $project->id, 'step' => 'install']) }}" class="btn btn-default" title="{{ trans('commands.configure') }}"><i class="fa fa-gear"></i></a>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="btn-group pull-right">
                            <a href="{{ route($route, ['project' => $project->id, 'step' => 'activate']) }}" class="btn btn-default" title="{{ trans('commands.configure') }}"><i class="fa fa-gear"></i></a>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="btn-group pull-right">
                            <a href="{{ route($route, ['project' => $project->id, 'step' => 'purge']) }}" class="btn btn-default" title="{{ trans('commands.configure') }}"><i class="fa fa-gear"></i></a>
                        </div>
                    </td>
                </tr>
            </tbody>
