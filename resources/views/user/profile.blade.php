                    ...
                    <div class="checkbox">
                        <label for="two-factor-auth">
                            @if ($user->hasTwoFactorAuthentication())
                                <input type="checkbox" id="two-factor-auth" name="two_factor" value="on" checked />
                            @else
                                <input type="checkbox" id="two-factor-auth" name="two_factor" value="on" />
                            @endif
                        ...
                        <span class="help-block">
                            ...
                            You need to download <a href="https://support.google.com/accounts/answer/1066447?hl=en" target="_blank">Google Authenticator</a> or a similar app.
                            When you login you will be asked to provide a security token generated by the app.
                        </span>
                    </div>
